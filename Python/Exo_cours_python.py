...
heure_debut = int(input("Quel est l'heure de début de la location du velo (sous format 24h)? "))
heure_fin = int(input("Quel est l'heure de fin de la location de vélo (sous format 24h)? "))
